...
var stripe = Stripe("pk_test_51MTwuEG7lwK5URD20Mmh0M4VzMuQLQWg0A6YVGIhC1KKfCrMAApGvcn2TEnEgsDXS4mKiWjUISW8ZKtnzjfWpGFc00ZeeQbpOf");
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(stadiumId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(stadiumId));
  ...
  return function bookStadium(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookStadium = bookStadium;
...
var bookBtn = document.getElementById("book-stadium"); // DELEGATION
// if (mapBox) {
...
if (bookBtn) bookBtn.addEventListener("click", function (e) {
  ...
  var stadiumId = e.target.dataset.stadiumId;
  (0, _stripe.bookStadium)(stadiumId);
});
